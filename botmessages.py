...
membed = discord.Embed(title=f"**You have opened a private report session with the Staff of the Tortoise Community!** ",
                       description="Someone will respond shortly, You can get on with your work.\n We will notify you.",
                       color=0xFF7000)
membed.set_footer(text="Tortoise Community")
membed.set_author(name="MOD-MAIL", icon_url="https://i.ibb.co/rxM1zqC/bot-2.png")

endbed = discord.Embed(title=f"**The Staff have closed the report session** ",
                       description="If you want to continue please type **t.report**", color=0xF92AFF)
endbed.set_footer(text="Tortoise Community")
endbed.set_author(name="MOD-MAIL", icon_url="https://i.ibb.co/rxM1zqC/bot-2.png")

modbed = discord.Embed(title=f"**MOD connected!** ",
                       description="You can use `t.stop `to end the session.\n(Do not misuse the Mod-mail)",
                       color=0x13D910)
